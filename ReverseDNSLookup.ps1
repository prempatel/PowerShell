...
$record = Get-DnsServerResourceRecord -ZoneName "takarabelmont.com" -ComputerName nj-vdc-01 -RRType "A" | where {$_.RecordData.IPV4Address -eq $searchIP} | select hostname, @{ Name = 'IPAddress'; Expression = { $_.RecordData.IPV4Address } }
